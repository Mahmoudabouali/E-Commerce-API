    ...
    public partial class OrderModule : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderEntitys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderEntitys_DeliveryMethods_deliveryMethodId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_OrderEntitys_OrderId",
                        column: x => x.OrderId,
                        principalTable: "OrderEntitys",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_OrderEntitys_deliveryMethodId",
                table: "OrderEntitys",
